...
**Purpose of Project:**
This portfolio project is a todo list app that showcases my skills in front-end web development, validation and sanitization of user-inupt data, and user-friendly, accessible design. It also served as a learning exercise in learning React, as I converted an [older project](https://github.com/manski117/todo-list-app-project) to React and Typescript from pure Javascript.
